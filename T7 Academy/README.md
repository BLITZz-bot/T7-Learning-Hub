...
### 💻 T7 Academy Setup Guide (New PC)

If you are setting up T7 Academy on a brand new machine, follow this streamlined checklist:

#### 1. Runtimes & System Tools
*   **Python (3.11+)**: [Download](https://www.python.org/downloads/) (Check "Add Python to PATH").
*   **Node.js (v18+)**: [Download](https://nodejs.org/).
*   **Git**: [Download](https://git-scm.com/downloads).
*   **FFmpeg**: [Download](https://ffmpeg.org/download.html) (Required for YouTube/Video processing).
...
*   `GROQ_API_KEY`: For fast Llama-3 processing.
*   `GEMINI_API_KEY`: For multimodal (video/image) features.
*   `FIREBASE_CONFIG_JSON`: Firebase config for Note Library.
*   `FIREBASE_STORAGE_BUCKET`: Firebase bucket URL.

#### 4. Running the App
*   **Backend**: `python -m deeptutor.api.run_server`
